...
const ListaProdukata = ({ produkti }) => {
    ...
    const [oxygenOptimal, setOxygenOptimal] = useState(0);

    useEffect(() => {
        produkti.map((prod) => console.log(prod));
    }, []);
    ...
    <div className="min-h-screen px-60 mt-32">
        <div className="flex w-full min-h-screen">
            <div className="w-72 flex flex-col gap-8 min-h-screen">
                <div className="w-full min-h-96 sticky top-40 px-5 py-4 bg-[#E8E8E8] flex flex-col gap-4 justify-center">
                ...
                <div className="w-full h-36 sticky top-[33rem] px-5 py-4 bg-[#E8E8E8] flex flex-col gap-4 text-center justify-center">
            ...
            <div className="w-full flex flex-col pl-8">
                <div className="w-full h-12 mb-8 flex justify-between items-center px-4 bg-red-400">
                    <p>9 od 104</p>
                    <Dropdown label="Sortiraj po:" values={["Cijeni", "A-Z"]} />
                </div>

                <div className="w-full min-h-96 grid grid-cols-3 gap-x-2 gap-y-5 justify-between text-center">
