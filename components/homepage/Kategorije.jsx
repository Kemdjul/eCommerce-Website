  ...
  return (
    <div className="flex flex-col w-full min-h-[37.5rem] bg-orange-400 text-white">
      <div className="w-full min-h-[18.75rem] md:flex max-md:grid bg-cyan-400">
        <Link onClick={() => setKategorija('Oxygen Optimal')} href='/trgovina' className="flex flex-col w-full max-md:min-h-[18.75rem] justify-center px-12 max-md:gap-8 md:gap-16">
          <Image 
            src={Oxygen} 
            alt="Oxygen Optimal" 
          ...
          <p onClick={() => setKategorija('Oxygen Optimal')} className="text-[0.938rem] font-[600] border-b-2 w-12 z-10">Više...</p>
        </Link>
        ...
        <Link href='/trgovina' className="flex flex-col w-full max-md:min-h-[18.75rem] justify-center max-md:px-12 max-md:gap-8 md:gap-16">
          ...
          <p onClick={() => setKategorija('Dodaci prehrani')} className="text-[0.938rem] font-[600] border-b-2 w-12 z-10">Više...</p>
        </Link>
      </div>

      <div className="w-full min-h-[18.75rem] md:flex max-md:grid bg-cyan-400">
        <Link onClick={() => setKategorija('Tinkture i čajevi')} href='/trgovina' className="flex flex-col w-full max-md:min-h-[18.75rem] justify-center px-12 max-md:gap-8 md:gap-16">
          <Image 
            src={Cajevi} 
        ...
        <Link href='/trgovina' className="flex flex-col w-full max-md:min-h-[18.75rem] justify-center max-md:px-12 max-md:gap-8 md:gap-16">
          ...
          <p onClick={() => setKategorija('Gelovi i kreme')} className="text-[0.938rem] font-[600] border-b-2 w-12 z-10">Više...</p>
        </Link>
      </div>
    </div>
  )
